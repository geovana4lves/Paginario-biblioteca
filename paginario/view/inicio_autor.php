...
document.getElementById("myInput").addEventListener("keyup", myFunction);
  ...
  <div class="add-book-button" style="margin-left: 30px; margin-top: 25px;">
    <a href="../adicionar_livro_autor.php" style="text-decoration: none; color: #fff; background-color: #86541c; padding: 10px 20px; border-radius: 20px; font-weight: bold; font-size: 20px;">📚 Publicar Meu Livro</a>
  </div>
    <div class="book-grid">
