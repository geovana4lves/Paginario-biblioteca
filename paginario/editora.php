...
// Buscar livros
$sql = "SELECT L.id_livro, L.editor, L.titulo, L.autor, L.classificacao_indicativa, L.capa, L.genero FROM Livro L ORDER BY L.titulo";
...
<header>
    ...
    <div class="search-container">
        <input type="text" id="myInput" placeholder="Pesquisar Editoras..." title="Digite o nome do Livro">
    </div>
</header>
        ...
        <?php foreach ($livros as $livro): ?>
            <div class="book-card">
                <a href="detalhes_livro.php?id=<?= $livro['id_livro']; ?>" style="text-decoration: none; color: inherit;">
                    <h2><?= htmlspecialchars($livro['editor']); ?></h2><br>
